...
export default function LoginPage() {
  ...
  const handleMouseMove = (e) => {
    // Calculate mouse position relative to screen center, normalized from -1 to 1
  ...
  return (
    ...
    >
      ...
      {/* Top Navigation Bar purely for returning to home */}
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        <div className="w-full max-w-md">
          ...
          {/* Form Card */}
          <div className="glass-card bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 md:p-8 shadow-xl">
            {/* Social Logins */}
